...
class UserRegistrationForm(FlaskForm):
    first_name = StringField('First Name', [DataRequired(), Length(4, 100, 'First name should consist of 4-200 characters')])
    last_name = StringField('Last Name', [DataRequired(), Length(4, 100, 'Last name should consist of 4-200 characters')])
    username = StringField('Username (4-30)', [DataRequired(), Length(4, 30, 'Username should consist of 4-30 characters')])
    password = PasswordField('Password (6-40)', [DataRequired(), Length(6, 40, 'Passowrd should consist of 6-40 characters')])
